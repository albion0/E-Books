...
import { createAuthor } from "../../../store/actions/actions";

export const CreateAuthor = ({ visible, recallAllAuthors, handleModal }) => {
  const {
    register,
    handleSubmit,
    setValue,
  ...
  const onSubmit = async (data) => {
    ...
    await dispatch(
      createAuthor(payload, {
        ...
        history,
        pathname: null,
        onSuccessMessage: "Author created successfully!",
        onFailMessage: "Failed to create Author!",
      })
    );
